...
class Driver(db.Model):
    ...
    license_plate = db.Column(db.String(20), unique=True, nullable=False)  # Plaque d'immatriculation du véhicule
    ...
    def to_dict(self):
        ...
        return {
            ...
            'license_plate': self.license_plate,  # Plaque d'immatriculation du véhicule
