# Guide de Configuration des Favicons et Icônes TéMove

## Problème
Les favicons et icônes affichés dans l'onglet du navigateur ne correspondent pas au logo TéMove.
...
2. Uploader le logo TéMove depuis `assets/logos/temove_logo.svg` ou `assets/icons/app_logo.png`
...
### TéMove (Client)
- `temove/web/favicon.svg`
- `temove/web/favicon.png`
- `temove/web/icons/Icon-192.png`
- `temove/web/icons/Icon-512.png`
- `temove/web/icons/Icon-maskable-192.png`
- `temove/web/icons/Icon-maskable-512.png`
...
3. **Vérifier dans l'onglet du navigateur** :
   - Le favicon TéMove doit s'afficher dans l'onglet
   - Le titre doit être "TéMove - Votre trajet, notre hospitalité" (ou "TéMove Pro - Application Chauffeurs")
