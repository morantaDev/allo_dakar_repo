# Script PowerShell pour generer les favicons et icones depuis le logo TeMove Pro
# Ce script copie le logo SVG/PNG depuis les assets et genere tous les fichiers necessaires

$ErrorActionPreference = "Stop"

Write-Host "Generation des favicons et icones TeMove Pro depuis les assets..." -ForegroundColor Cyan

# Chemins des assets
$logoPath = "assets\logos\temove_pro_logo.svg"
